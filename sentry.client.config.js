...
Sentry.init({
  dsn: import.meta.env.PUBLIC_SENTRY_DSN || config.sentry.dsn,
  ...
  integrations: [
    ...
    ...(config.sentry.feedback_integration
  ...
  environment:
    import.meta.env.PUBLIC_SENTRY_ENVIRONMENT || config.site.environment,
});
